...
public class Controller extends HttpServlet {
	...
	private void deleteEmployee(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(employeeDAO.delete(Integer.parseInt(id))) {
			request.setAttribute("NOTIFICATION", "Funcionário deletado!");
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(id.isEmpty() || id == null) {
			...
			if(employeeDAO.save(e)) {
				request.setAttribute("NOTIFICATION", "Funcionário registrado com sucesso!");
			}
			...
			if(employeeDAO.update(e)) {
				request.setAttribute("NOTIFICATION", "Funcionário atualizado com sucesso!");
			}
